...
public class GenericIntSerializer<T extends IHaveLoader<?>> implements IGenericLoader<T> {
  ...
  public void serialize(T object, JsonObject json) {
    json.addProperty(this.key, this.getter.applyAsInt(object));
  }

  @Override
  public T deserialize(JsonObject json) {
    return this.constructor.apply(GsonHelper.getAsInt(json, this.key));
  }

  @Override
  public void toNetwork(T object, FriendlyByteBuf buffer) {
    buffer.writeVarInt(this.getter.applyAsInt(object));
  }

  @Override
  public T fromNetwork(FriendlyByteBuf buffer) {
    return this.constructor.apply(buffer.readVarInt());
  }
}
