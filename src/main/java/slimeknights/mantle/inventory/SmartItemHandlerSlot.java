...
public class SmartItemHandlerSlot extends SlotItemHandler {
  ...
  public int getMaxStackSize(ItemStack stack) {
    var storage = this.getItemHandler();
    return (int) Math.min(stack.getMaxStackSize(), storage instanceof SlottedStackStorage slottedStackStorage ? slottedStackStorage.getSlotLimit(this.getSlotIndex()) : storage.getSlot(this.getSlotIndex()).getCapacity());
  }
}
