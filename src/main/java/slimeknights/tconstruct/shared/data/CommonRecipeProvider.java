...
public class CommonRecipeProvider extends BaseRecipeProvider implements ICommonRecipeHelper {
  ...
  private void addCommonRecipes(Consumer<FinishedRecipe> consumer) {
    ...
    // nahuatl
    this.slabStairsCrafting(consumer, TinkerMaterials.nahuatl, folder, false);
    ShapedRecipeBuilder.shaped(RecipeCategory.MISC, TinkerMaterials.nahuatl.getFence(), 6)
      ...
      .save(consumer, this.modResource(folder + "nahuatl_fence"));
    ...
    ShapedRecipeBuilder.shaped(RecipeCategory.MISC, TinkerCommons.goldBars, 16)
      ...
      .save(consumer, this.modResource("common/gold_bars"));
    ShapedRecipeBuilder.shaped(RecipeCategory.MISC, TinkerCommons.goldPlatform, 4)
      ...
      .save(consumer, this.modResource("common/gold_platform"));
    ShapedRecipeBuilder.shaped(RecipeCategory.MISC, TinkerCommons.ironPlatform, 4)
      ...
      .save(consumer, this.modResource("common/iron_platform"));
    ShapedRecipeBuilder.shaped(RecipeCategory.MISC, TinkerCommons.copperPlatform.get(WeatherState.UNAFFECTED), 4)
      ...
      .save(consumer, this.modResource("common/copper_platform"));
    ShapedRecipeBuilder.shaped(RecipeCategory.MISC, TinkerCommons.cobaltPlatform, 4)
      ...
      .save(consumer, this.modResource("common/cobalt_platform"));
    TinkerCommons.waxedCopperPlatform.forEach((age, block) -> {
      ...
      ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, block)
        ...
        .save(consumer, this.modResource("common/copper_platform_waxing_" + age.toString().toLowerCase(Locale.ROOT)));
    });
    ...
    ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, TinkerCommons.materialsAndYou)
      ...
      .save(consumer, this.prefix(TinkerCommons.materialsAndYou.getRegistryName(), "common/"));
    ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, TinkerCommons.tinkersGadgetry)
      ...
      .save(consumer, this.prefix(TinkerCommons.tinkersGadgetry.getRegistryName(), "common/"));
    ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, TinkerCommons.punySmelting)
      ...
      .save(consumer, this.prefix(TinkerCommons.punySmelting.getRegistryName(), "common/"));
    ItemCastingRecipeBuilder.tableRecipe(TinkerCommons.mightySmelting)
      ...
      .save(consumer, this.prefix(TinkerCommons.mightySmelting.getRegistryName(), "common/"));
    ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, TinkerCommons.fantasticFoundry)
      ...
      .save(consumer, this.prefix(TinkerCommons.fantasticFoundry.getRegistryName(), "common/"));
    ItemCastingRecipeBuilder.tableRecipe(TinkerCommons.encyclopedia)
      ...
      .setCast(Items.BOOK, true)
      .save(consumer, this.prefix(TinkerCommons.encyclopedia.getRegistryName(), "common/"));
    ...
    ShapedRecipeBuilder.shaped(RecipeCategory.MISC, TinkerCommons.clearGlassPane, 16)
      ...
      .save(consumer, this.prefix(TinkerCommons.clearGlassPane.getRegistryName(), folder));
    for (GlassColor color : GlassColor.values()) {
      ...
      ShapedRecipeBuilder.shaped(RecipeCategory.MISC, block, 8)
        ...
        .pattern("#X#")
        .pattern("###")
        .group(this.modPrefix("stained_clear_glass"))
        .unlockedBy("has_clear_glass", has(TinkerCommons.clearGlass))
        .save(consumer, this.prefix(BuiltInRegistries.BLOCK.getKey(block), folder));
      Block pane = TinkerCommons.clearStainedGlassPane.get(color);
      ShapedRecipeBuilder.shaped(RecipeCategory.MISC, pane, 16)
        .define('#', block)
        .pattern("###")
        .pattern("###")
        .group(this.modPrefix("stained_clear_glass_pane"))
        .unlockedBy("has_block", has(block))
        .save(consumer, this.prefix(BuiltInRegistries.BLOCK.getKey(pane), folder));
      ShapedRecipeBuilder.shaped(RecipeCategory.MISC, pane, 8)
        ...
        .save(consumer, this.wrap(BuiltInRegistries.BLOCK.getKey(pane), folder, "_from_panes"));
    }
    // fix vanilla recipes not using tinkers glass
    String glassVanillaFolder = folder + "vanilla/";
    Consumer<FinishedRecipe> vanillaGlassConsumer = this.withCondition(consumer, ConfigEnabledCondition.GLASS_RECIPE_FIX);
    ShapedRecipeBuilder.shaped(RecipeCategory.MISC, Blocks.BEACON)
      ...
      .save(vanillaGlassConsumer, this.prefix(BuiltInRegistries.BLOCK.getKey(Blocks.BEACON), glassVanillaFolder));
    ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE, Blocks.DAYLIGHT_DETECTOR)
      ...
      .save(vanillaGlassConsumer, this.prefix(BuiltInRegistries.BLOCK.getKey(Blocks.DAYLIGHT_DETECTOR), glassVanillaFolder));
    ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, Items.END_CRYSTAL)
      ...
      .save(vanillaGlassConsumer, this.prefix(BuiltInRegistries.ITEM.getKey(Items.END_CRYSTAL), glassVanillaFolder));
    ShapedRecipeBuilder.shaped(RecipeCategory.MISC, Items.GLASS_BOTTLE, 3)
      ...
      .save(vanillaGlassConsumer, this.prefix(BuiltInRegistries.ITEM.getKey(Items.GLASS_BOTTLE), glassVanillaFolder));
    ...
    ShapedRecipeBuilder.shaped(RecipeCategory.MISC, Blocks.BLAST_FURNACE)
      ...
      .save(consumer, this.modResource("common/basalt_blast_furnace"));
  }
  ...
  private void addMaterialRecipes(Consumer<FinishedRecipe> consumer) {
    ...
    this.packingRecipe(consumer, "ingot", Items.COPPER_INGOT, "nugget", TinkerMaterials.copperNugget, TinkerTags.Items.NUGGETS_COPPER, folder);
    this.packingRecipe(consumer, "ingot", Items.NETHERITE_INGOT, "nugget", TinkerMaterials.netheriteNugget, TinkerTags.Items.NUGGETS_NETHERITE, folder);
    // tier 5
    ...
    SimpleCookingRecipeBuilder.blasting(Ingredient.of(TinkerWorld.rawCobalt, TinkerWorld.cobaltOre), RecipeCategory.MISC, cobaltIngot, 1.5f, 200)
      ...
      .save(consumer, this.wrap(cobaltIngot, folder, "_smelting"));
    // pack raw cobalt
    this.packingRecipe(consumer, "raw_block", TinkerWorld.rawCobaltBlock, "raw", TinkerWorld.rawCobalt, TinkerTags.Items.RAW_COBALT, folder);
  }
}
