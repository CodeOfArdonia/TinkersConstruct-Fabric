...
public interface INamespacedNBTView extends PlayerComponent<INamespacedNBTView> {
  ...
  default Tag get(ResourceLocation name) {
    return this.get(name, CompoundTag::get);
  }
  ...
  default int getInt(ResourceLocation name) {
    return this.get(name, CompoundTag::getInt);
  }
  ...
  default boolean getBoolean(ResourceLocation name) {
    return this.get(name, CompoundTag::getBoolean);
  }
  ...
  default float getFloat(ResourceLocation name) {
    return this.get(name, CompoundTag::getFloat);
  }
  ...
  default CompoundTag getCompound(ResourceLocation name) {
    return this.get(name, CompoundTag::getCompound);
  }
}
