...
public record MobDisguiseModule(EntityType<?> entity) implements EquipmentChangeModifierHook, ModifierModule {
  ...
  public static final IGenericLoader<MobDisguiseModule> LOADER = new RegistryEntryLoader<>("entity", BuiltInRegistries.ENTITY_TYPE, MobDisguiseModule::new, MobDisguiseModule::entity);
