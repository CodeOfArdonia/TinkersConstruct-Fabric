...
public class GreyToColorMapping implements IColorMapping {
  ...
  public int getColorForGrey(int grey) {
    if (this.recolorCache[grey] == null) {
      int calculated = getNearestByGrey(this.mappings, GET_GREY, grey, INTERPOLATE_COLORS);
  ...
  public int mapColor(int color) {
    ...
    return scaleColor(color, this.getColorForGrey(grey), grey);
  }
  ...
  public static class Builder {
    ...
    public Builder addABGR(int grey, int color) {
      this.checkGrey(grey);
      this.builder.add(new ColorMapping(grey, color));
      return this;
    }
    ...
    public Builder addARGB(int grey, int color) {
      this.checkGrey(grey);
      this.builder.add(new ColorMapping(grey, Util.translateColorBGR(color)));
      return this;
    }
    ...
    public GreyToColorMapping build() {
      List<ColorMapping> list = this.builder.build();
      if (list.size() < 2) {
