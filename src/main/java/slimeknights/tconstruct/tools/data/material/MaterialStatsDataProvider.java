...
public class MaterialStatsDataProvider extends AbstractMaterialStatsDataProvider {
  ...
  private void addMeleeHarvest() {
    ...
    this.addMaterialStats(MaterialIds.wood,
    ...
    this.addMaterialStats(MaterialIds.chorus,
      ...
      ExtraMaterialStats.DEFAULT);
    // tier 1 - binding
    this.addMaterialStats(MaterialIds.string, ExtraMaterialStats.DEFAULT);
    this.addMaterialStats(MaterialIds.leather, ExtraMaterialStats.DEFAULT);
    this.addMaterialStats(MaterialIds.vine, ExtraMaterialStats.DEFAULT);

    // tier 2
    // vanilla iron: 250, 6f, IRON, 2f
    this.addMaterialStats(MaterialIds.iron,
      new HeadMaterialStats(250, 6f, IRON, 2f),
      HandleMaterialStats.DEFAULT.withDurability(1.10f),
      ExtraMaterialStats.DEFAULT);
    this.addMaterialStats(MaterialIds.searedStone,
      ...
      ExtraMaterialStats.DEFAULT);
    this.addMaterialStats(MaterialIds.bloodbone,
      ...
      ExtraMaterialStats.DEFAULT);
    this.addMaterialStats(MaterialIds.slimewood,
      ...
      ExtraMaterialStats.DEFAULT);
    // tier 2 - nether
    this.addMaterialStats(MaterialIds.scorchedStone,
      ...
      ExtraMaterialStats.DEFAULT);
    this.addMaterialStats(MaterialIds.necroticBone,
      ...
      ExtraMaterialStats.DEFAULT);
    // tier 2 - end
    this.addMaterialStats(MaterialIds.whitestone,
      ...
      ExtraMaterialStats.DEFAULT);
    // tier 2 - bindings
    this.addMaterialStats(MaterialIds.chain, ExtraMaterialStats.DEFAULT);
    this.addMaterialStats(MaterialIds.skyslimeVine, ExtraMaterialStats.DEFAULT);

    // tier 2 (mod integration)
    this.addMaterialStats(MaterialIds.osmium,
      ...
      ExtraMaterialStats.DEFAULT);
    this.addMaterialStats(MaterialIds.tungsten,
      ...
      ExtraMaterialStats.DEFAULT);
    this.addMaterialStats(MaterialIds.platinum,
      ...
      ExtraMaterialStats.DEFAULT);
    this.addMaterialStats(MaterialIds.silver,
      ...
      ExtraMaterialStats.DEFAULT);
    this.addMaterialStats(MaterialIds.lead,
    ...
    this.addMaterialStats(MaterialIds.nahuatl,
      ...
      ExtraMaterialStats.DEFAULT);
    this.addMaterialStats(MaterialIds.pigIron,
    ...
    this.addMaterialStats(MaterialIds.roseGold,
      ...
      ExtraMaterialStats.DEFAULT);
    // tier 3 (nether)
    this.addMaterialStats(MaterialIds.cobalt,
    ...
    this.addMaterialStats(MaterialIds.necronium,
      ...
      ExtraMaterialStats.DEFAULT);
    this.addMaterialStats(MaterialIds.electrum,
      ...
      ExtraMaterialStats.DEFAULT);
    this.addMaterialStats(MaterialIds.platedSlimewood,
    ...
    this.addMaterialStats(MaterialIds.queensSlime,
      ...
      ExtraMaterialStats.DEFAULT);
    this.addMaterialStats(MaterialIds.hepatizon,
      ...
      ExtraMaterialStats.DEFAULT);
    this.addMaterialStats(MaterialIds.manyullyn,
      ...
      ExtraMaterialStats.DEFAULT);
    this.addMaterialStats(MaterialIds.blazingBone,
      ...
      ExtraMaterialStats.DEFAULT);
    this.addMaterialStats(MaterialIds.ancientHide, ExtraMaterialStats.DEFAULT);

    // tier 4 (end)
    this.addMaterialStats(MaterialIds.enderslimeVine, ExtraMaterialStats.DEFAULT);
  }
  ...
  private void addRanged() {
    ...
    this.addMaterialStats(MaterialIds.bamboo,
    ...
    // tier 1 - bowstring
    this.addMaterialStats(MaterialIds.string, BowstringMaterialStats.DEFAULT);
    this.addMaterialStats(MaterialIds.vine, BowstringMaterialStats.DEFAULT);
    ...
    // tier 2 - bowstring
    this.addMaterialStats(MaterialIds.chain, BowstringMaterialStats.DEFAULT);
    this.addMaterialStats(MaterialIds.skyslimeVine, BowstringMaterialStats.DEFAULT);

    // tier 2 - compat
    this.addMaterialStats(MaterialIds.platinum,
      new LimbMaterialStats(400, -0.05f, 0, 0.1f),
      new GripMaterialStats(1.05f, 0.05f, 1.5f));
    this.addMaterialStats(MaterialIds.aluminum,
    ...
    // tier 3 - bowstring
    this.addMaterialStats(MaterialIds.darkthread, BowstringMaterialStats.DEFAULT);
    ...
    // tier 4 (end)
    this.addMaterialStats(MaterialIds.enderslimeVine, BowstringMaterialStats.DEFAULT);
  }

  private void addMisc() {
    // travelers gear
    this.addMaterialStats(MaterialIds.leather, new RepairKitStats(150));
    // slimeskull
    this.addMaterialStats(MaterialIds.glass, new SkullStats(90, 0));
    this.addMaterialStats(MaterialIds.enderPearl, new SkullStats(180, 0));
    this.addMaterialStats(MaterialIds.bone, new SkullStats(100, 0));
    this.addMaterialStats(MaterialIds.bloodbone, new SkullStats(175, 1));
    this.addMaterialStats(MaterialIds.necroticBone, new SkullStats(125, 0));
    this.addMaterialStats(MaterialIds.string, new SkullStats(140, 0));
    this.addMaterialStats(MaterialIds.darkthread, new SkullStats(200, 1));
    this.addMaterialStats(MaterialIds.rottenFlesh, new SkullStats(45, 2));
    this.addMaterialStats(MaterialIds.iron, new SkullStats(165, 2));
    this.addMaterialStats(MaterialIds.copper, new SkullStats(145, 2));
    this.addMaterialStats(MaterialIds.blazingBone, new SkullStats(205, 1));
    this.addMaterialStats(MaterialIds.gold, new SkullStats(125, 0));
    this.addMaterialStats(MaterialIds.roseGold, new SkullStats(175, 1));
    this.addMaterialStats(MaterialIds.pigIron, new SkullStats(150, 2));
    // slimesuit
    this.addMaterialStats(MaterialIds.enderslime, new RepairKitStats(30));
    this.addMaterialStats(MaterialIds.phantom, new RepairKitStats(324));
    // crafting
    this.addMaterialStats(MaterialIds.obsidian);
    this.addMaterialStats(MaterialIds.debris);
    this.addMaterialStats(MaterialIds.netherite);
    this.addMaterialStats(MaterialIds.earthslime);
    this.addMaterialStats(MaterialIds.skyslime);
    this.addMaterialStats(MaterialIds.blood);
    this.addMaterialStats(MaterialIds.ichor);
    this.addMaterialStats(MaterialIds.clay);
    this.addMaterialStats(MaterialIds.honey);
    //addMaterialStats(MaterialIds.venom);
    // compat
    this.addMaterialStats(MaterialIds.aluminum);
    this.addMaterialStats(MaterialIds.nickel);
    this.addMaterialStats(MaterialIds.tin);
    this.addMaterialStats(MaterialIds.zinc);
    this.addMaterialStats(MaterialIds.brass);
    this.addMaterialStats(MaterialIds.uranium);
  }
}
