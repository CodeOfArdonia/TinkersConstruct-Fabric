...
public class ModifierProvider extends AbstractModifierProvider implements IConditionBuilder {
  ...
  protected void addModifiers() {
    ...
    buildModifier(ModifierIds.reach)
      ...
      .addModule(AttributeModule.builder(PortingLibAttributes.BLOCK_REACH, Operation.ADDITION).uniqueFrom(ModifierIds.reach).eachLevel(1))
      .addModule(AttributeModule.builder(PortingLibAttributes.ENTITY_REACH, Operation.ADDITION).uniqueFrom(ModifierIds.reach).eachLevel(1));
    ...
    buildModifier(ModifierIds.stepUp).addModule(AttributeModule.builder(PortingLibAttributes.STEP_HEIGHT_ADDITION, Operation.ADDITION).uniqueFrom(ModifierIds.stepUp).slots(armorSlots).eachLevel(0.5f));
