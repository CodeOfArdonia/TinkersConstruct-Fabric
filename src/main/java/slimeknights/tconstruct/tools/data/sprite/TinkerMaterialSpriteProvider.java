...
public class TinkerMaterialSpriteProvider extends AbstractMaterialSpriteProvider {
  ...
  protected void addAllMaterials() {
    // tier 1
    this.buildMaterial(MaterialIds.flint)
      .meleeHarvest()
    ...
    this.buildMaterial(MaterialIds.basalt)
      .meleeHarvest()
      .fallbacks("crystal", "rock", "stick")
    ...
    this.buildMaterial(MaterialIds.bone)
      .meleeHarvest().ranged()
      .fallbacks("bone", "rock")
    ...
    this.buildMaterial(MaterialIds.necroticBone)
      .meleeHarvest().ranged()
      .fallbacks("bone", "rock")
    ...
    this.buildMaterial(MaterialIds.leather)
    ...
    this.buildMaterial(MaterialIds.string)
    ...
    this.buildMaterial(MaterialIds.vine)
    ...
    this.buildMaterial(MaterialIds.chorus)
      .meleeHarvest().ranged()
      .fallbacks("rock")
    ...
    // tier 1 - wood
    this.buildMaterial(MaterialIds.wood)
      .meleeHarvest().ranged()
    ...
    this.buildMaterial(MaterialIds.oak)
      .meleeHarvest().ranged()
      .fallbacks("wood", "stick", "primitive")
    ...
    this.buildMaterial(MaterialIds.spruce)
      .meleeHarvest().ranged()
      .fallbacks("wood", "stick", "primitive")
    ...
    this.buildMaterial(MaterialIds.birch)
      .meleeHarvest().ranged()
      .fallbacks("wood", "stick", "primitive")
    ...
    this.buildMaterial(MaterialIds.jungle)
      .meleeHarvest().ranged()
      .fallbacks("wood", "stick", "primitive")
    ...
    this.buildMaterial(MaterialIds.darkOak)
      .meleeHarvest().ranged()
      .fallbacks("wood", "stick", "primitive")
    ...
    this.buildMaterial(MaterialIds.acacia)
      .meleeHarvest().ranged()
      .fallbacks("wood", "stick", "primitive")
    ...
    this.buildMaterial(MaterialIds.crimson)
      .meleeHarvest().ranged()
      .fallbacks("wood", "stick", "primitive")
    ...
    this.buildMaterial(MaterialIds.warped)
      .meleeHarvest().ranged()
      .fallbacks("wood", "stick", "primitive")
    ...
    this.buildMaterial(MaterialIds.bamboo)
      .ranged()
      .fallbacks("wood", "stick", "primitive")
    ...
    // tier 1 - stone
    this.buildMaterial(MaterialIds.stone)
      .meleeHarvest()
      .fallbacks("rock")
    ...
    this.buildMaterial(MaterialIds.andesite)
      .meleeHarvest()
      .fallbacks("rock")
    ...
    this.buildMaterial(MaterialIds.diorite)
      .meleeHarvest()
      .fallbacks("rock")
    ...
    this.buildMaterial(MaterialIds.granite)
      .meleeHarvest()
      .fallbacks("rock")
    ...
    this.buildMaterial(MaterialIds.deepslate)
      .meleeHarvest()
      .fallbacks("rock")
    ...
    this.buildMaterial(MaterialIds.blackstone)
      .meleeHarvest()
      .fallbacks("rock")
    ...
    // tier 2
    this.buildMaterial(MaterialIds.iron)
    ...
    this.buildMaterial(MaterialIds.oxidizedIron)
      .meleeHarvest().statType(TinkerPartSpriteProvider.PLATE)
      .fallbacks("metal").ranged()
    ...
    this.buildMaterial(MaterialIds.copper)
    ...
    this.buildMaterial(MaterialIds.oxidizedCopper)
      .meleeHarvest().ranged().statType(TinkerPartSpriteProvider.PLATE)
      .fallbacks("metal")
    ...
    this.buildMaterial(MaterialIds.searedStone)
      .meleeHarvest()
      .fallbacks("rock")
    ...
    this.buildMaterial(MaterialIds.bloodbone)
      .meleeHarvest().ranged()
      .fallbacks("bone", "rock")
    ...
    this.buildMaterial(MaterialIds.endstone)
      .meleeHarvest()
      .fallbacks("rock")
    ...
    this.buildMaterial(MaterialIds.osmium)
      .meleeHarvest().statType(TinkerPartSpriteProvider.PLATE)
      .fallbacks("metal")
    ...
    this.buildMaterial(MaterialIds.platinum)
      .meleeHarvest().ranged().statType(TinkerPartSpriteProvider.PLATE)
      .fallbacks("metal")
    ...
    this.buildMaterial(MaterialIds.tungsten)
      .meleeHarvest().ranged().statType(TinkerPartSpriteProvider.PLATE)
      .fallbacks("metal")
    ...
    this.buildMaterial(MaterialIds.lead)
      .meleeHarvest().ranged().statType(TinkerPartSpriteProvider.PLATE)
      .fallbacks("metal")
    ...
    this.buildMaterial(MaterialIds.silver)
      .meleeHarvest().ranged().statType(TinkerPartSpriteProvider.PLATE)
      .fallbacks("metal")
    ...
    this.buildMaterial(MaterialIds.whitestone)
      .meleeHarvest()
      .fallbacks("rock")
    ...
    this.buildMaterial(MaterialIds.scorchedStone)
      .meleeHarvest()
      .fallbacks("rock")
    ...
    this.buildMaterial(MaterialIds.aluminum)
    ...
    // tier 2 - slimewood
    this.buildMaterial(MaterialIds.greenheart)
      .meleeHarvest().ranged()
    ...
    this.buildMaterial(MaterialIds.skyroot)
      .meleeHarvest().ranged()
      .fallbacks("wood", "primitive")
    ...
    this.buildMaterial(MaterialIds.bloodshroom)
      .meleeHarvest().ranged()
      .fallbacks("wood", "primitive")
    ...
    // tier 3
    this.buildMaterial(MaterialIds.chain)
      .statType(ExtraMaterialStats.ID, BowstringMaterialStats.ID)
    ...
    this.buildMaterial(MaterialIds.skyslimeVine)
      .statType(ExtraMaterialStats.ID, BowstringMaterialStats.ID)
      .fallbacks("primitive")
    ...
    this.buildMaterial(MaterialIds.slimesteel)
      .meleeHarvest().ranged().statType(TinkerPartSpriteProvider.PLATE)
    ...
    this.buildMaterial(MaterialIds.amethystBronze)
      .meleeHarvest().ranged().statType(TinkerPartSpriteProvider.PLATE)
      .fallbacks("metal")
    ...
    this.buildMaterial(MaterialIds.nahuatl)
      .meleeHarvest().ranged()
    ...
    this.buildMaterial(MaterialIds.pigIron)
      .meleeHarvest().statType(TinkerPartSpriteProvider.PLATE)
      .fallbacks("metal")
    ...
    this.buildMaterial(MaterialIds.roseGold)
      .meleeHarvest().ranged().statType(TinkerPartSpriteProvider.PLATE)
      .fallbacks("metal")
    ...
    this.buildMaterial(MaterialIds.steel)
      .meleeHarvest().ranged().statType(TinkerPartSpriteProvider.PLATE)
      .fallbacks("metal")
    ...
    this.buildMaterial(MaterialIds.bronze)
      .meleeHarvest().ranged().statType(TinkerPartSpriteProvider.PLATE)
      .fallbacks("metal")
    ...
    this.buildMaterial(MaterialIds.constantan)
      .meleeHarvest().ranged().statType(TinkerPartSpriteProvider.PLATE)
      .fallbacks("metal")
    ...
    this.buildMaterial(MaterialIds.invar)
      .meleeHarvest().ranged().statType(TinkerPartSpriteProvider.PLATE)
      .fallbacks("metal")
    ...
    this.buildMaterial(MaterialIds.necronium)
      .meleeHarvest().ranged()
      .fallbacks("bone", "metal")
      .colorMapper(uraniumPalette);
    this.buildMaterial(MaterialIds.electrum)
      .meleeHarvest().ranged().statType(TinkerPartSpriteProvider.PLATE)
      .fallbacks("metal")
    ...
    this.buildMaterial(MaterialIds.platedSlimewood)
      .meleeHarvest().ranged()
      .fallbacks("slime_metal", "metal")
      .colorMapper(brassPalette);
    this.buildMaterial(MaterialIds.cobalt)
      .meleeHarvest().ranged().statType(TinkerPartSpriteProvider.PLATE)
      .fallbacks("metal")
    ...
    this.buildMaterial(MaterialIds.darkthread)
      .statType(ExtraMaterialStats.ID, BowstringMaterialStats.ID, RepairKitStats.ID)
      .fallbacks("primitive")
    ...
    this.buildMaterial(MaterialIds.queensSlime)
      .meleeHarvest().ranged()
      .fallbacks("slime_metal", "metal")
      .transformer(GreyToSpriteTransformer.builderFromBlack()
        ...
        .build());
    this.buildMaterial(MaterialIds.hepatizon)
      .meleeHarvest().ranged().statType(TinkerPartSpriteProvider.PLATE)
      .fallbacks("metal")
    ...
    this.buildMaterial(MaterialIds.manyullyn)
      .meleeHarvest().ranged().statType(TinkerPartSpriteProvider.PLATE)
      .fallbacks("metal")
    ...
    this.buildMaterial(MaterialIds.blazingBone)
      .meleeHarvest().ranged()
      .fallbacks("bone", "rock")
    ...
    this.buildMaterial(MaterialIds.ancientHide)
      .statType(ExtraMaterialStats.ID)
      .colorMapper(ancientDebrisPalette);
    this.buildMaterial(MaterialIds.enderslimeVine)
      .statType(ExtraMaterialStats.ID, BowstringMaterialStats.ID)
      .fallbacks("primitive")
    ...
    // plate
    this.buildMaterial(MaterialIds.obsidian).statType(TinkerPartSpriteProvider.PLATE).fallbacks("rock").colorMapper(obsidianPalette);
    this.buildMaterial(MaterialIds.debris).statType(TinkerPartSpriteProvider.PLATE).fallbacks("rock").colorMapper(ancientDebrisPalette);
    this.buildMaterial(MaterialIds.netherite)
    ...
    this.buildMaterial(MaterialIds.gold)
    ...
    // compat plate
    this.buildMaterial(MaterialIds.nickel)
      .statType(TinkerPartSpriteProvider.PLATE)
      .fallbacks("metal")
    ...
    this.buildMaterial(MaterialIds.tin)
      .statType(TinkerPartSpriteProvider.PLATE)
      .fallbacks("metal")
    ...
    this.buildMaterial(MaterialIds.zinc)
      .statType(TinkerPartSpriteProvider.PLATE)
      .fallbacks("metal")
    ...
    this.buildMaterial(MaterialIds.brass).statType(TinkerPartSpriteProvider.PLATE).fallbacks("metal").colorMapper(brassPalette);
    this.buildMaterial(MaterialIds.uranium).statType(TinkerPartSpriteProvider.PLATE).fallbacks("metal").colorMapper(uraniumPalette);


    // slimeskull
    this.buildMaterial(MaterialIds.glass)
    ...
    this.buildMaterial(MaterialIds.enderPearl)
    ...
    this.buildMaterial(MaterialIds.rottenFlesh)
    ...
    // slimesuit
    this.buildMaterial(MaterialIds.enderslime)
    ...
    this.buildMaterial(MaterialIds.phantom)
      .statType(RepairKitStats.ID).fallbacks("wood")
    ...
    this.buildMaterial(MaterialIds.earthslime)
    ...
    this.buildMaterial(MaterialIds.skyslime)
      .statType(TinkerPartSpriteProvider.SLIMESUIT)
    ...
    this.buildMaterial(MaterialIds.blood)
      .statType(TinkerPartSpriteProvider.SLIMESUIT)
    ...
    this.buildMaterial(MaterialIds.ichor)
      .statType(TinkerPartSpriteProvider.SLIMESUIT)
    ...
    this.buildMaterial(MaterialIds.clay)
      .statType(TinkerPartSpriteProvider.SLIMESUIT)
    ...
    this.buildMaterial(MaterialIds.honey)
      .statType(TinkerPartSpriteProvider.SLIMESUIT)
