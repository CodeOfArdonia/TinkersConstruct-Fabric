...
public class CastingItemRenderTypeBuffer implements MultiBufferSource {
  ...
  public VertexConsumer getBuffer(RenderType type) {
    if (this.alpha < 255 && MAKE_TRANSPARENT.contains(type.name) && type instanceof RenderType.CompositeRenderType composite && composite.state.textureState instanceof TextureStateShard textureState) {
